        ...
        <table class="table" border="1">
            ...
            <tr>
                ...
                if (!empty($_GET['keyword']))
                    {
                        $search = $_GET['keyword'];
                         $row_sql = "select * from phongban where tenpb like '%$search%'";
                    }
                ...
                <td>
                    <a onclick=" return confirm('bạn có chắc muốn sửa không')" href="Update_PB.php?id=<?php echo $dulieu['id'] ?>" title="sửa">Sửa
                    </a>
                </td>
                <td>
