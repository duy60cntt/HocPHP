...
<body>
    ...
    if (isset($_POST['NGASINH'])) $NGASINH = $_POST['NGASINH'];
    else $NGASINH = "";

    if (isset($_POST['GIOITINH'])) $GIOITINH = $_POST['GIOITINH'];
    else $GIOITINH = "";

    if (isset($_POST['DIACHI'])) $DIACHI = strval($_POST['DIACHI']);
    else $DIACHI = "";
    ...
    if (isset($_FILES['ANH'])) $ANH = $_FILES['ANH']["name"];
    else $ANH = "";


    if (isset($_POST['MALOAINV'])) $MALOAINV = $_POST['MALOAINV'];
    else $MALOAINV = "";

    if (isset($_POST['MAPHONG'])) $MAPHONG = $_POST['MAPHONG'];
    else $MAPHONG = "";
    ...
    $row_dulieu = mysqli_fetch_assoc($kq);
        ...
        <table border="1" cellspacing="0" cellpadding="10">
            ...
            <tr>
                ...
                <td>
                    ...
                    Nam <input type="radio" name="GIOITINH" value="1" <?php
                                                                        if ($row_dulieu['GIOITINH'] == 1) echo "checked";
                                                                        ?> />
                    Nữ <input type="radio" name="GIOITINH" value="0" <?php
